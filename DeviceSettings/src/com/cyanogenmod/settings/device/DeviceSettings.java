...
public class DeviceSettings extends PreferenceActivity implements OnSharedPreferenceChangeListener  {
    ...
    public boolean onPreferenceTreeClick(PreferenceScreen preferenceScreen, Preference preference) 
    {
        ...
        if(preference == mTouchwake) {
            ...
            new CMDProcessor().su.run("echo "+(mTouchwake.isChecked() ? "1" : "0")+" > /sys/class/misc/touchwake/enabled");
            new CMDProcessor().su.run("echo 90000 > /sys/class/misc/touchwake/delay");
        }
