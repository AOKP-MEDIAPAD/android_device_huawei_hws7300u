...
static  FPSRange FpsRangesSupported[] = {{MINIMUM_FPS*1000,MAXIMUM_FPS*1000}};
 ...
 if( mCfgControl.mm_camera_is_supported(CAMERA_PARM_FPS_MODE)){
    ...
    switch(mCurrentTarget){
        ...
        case TARGET_MSM7627A:
            ...
            break;
        case TARGET_MSM8660:
            mParameters.set(QCameraParameters::KEY_PREFERRED_PREVIEW_SIZE_FOR_VIDEO, "1280x720");
            break;
        default:
     ...
     struct ion_fd_data* ion_info_fd, int ion_type, int size, int *memfd)
{
    ...
    *main_ion_fd = open("/dev/ion", O_RDONLY );
    ...
    alloc->heap_mask = (ION_HEAP(ION_SF_HEAP_ID) | (ION_HEAP(ion_type)));
    alloc->flags = 0;
